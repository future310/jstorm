...
public class TransactionalGlobalCount {
  ...
  public static class BatchCount extends BaseBatchBolt {
    ...
    public void finishBatch() {
      Values values = new Values(_id, _count);
      System.out.println("BatchCount "+values.toString());
  ...
  public static class UpdateGlobalCount extends BaseTransactionalBolt implements ICommitter {
    ...
    public void finishBatch() {
      ...
      Values values =new Values("UpdateGlobalCount: "+_attempt, newval.count);
  ...
  public static void main(String[] args) throws Exception {
    ...
    TransactionalTopologyBuilder builder = new TransactionalTopologyBuilder("global-count", "mySpout", spout, 3);
    builder.setBolt("batchCount", new BatchCount(), 2).noneGrouping("mySpout");
    builder.setBolt("sum", new UpdateGlobalCount()).globalGrouping("batchCount");
